...
import couponsSelectors from 'src/modules/stacking/stackingSelectors';
...
function StackingListToolbar(props) {
  const [
...
export default StackingListToolbar;
