...
function StackingFormPage(props) {
  ...
  const title = isEditing
    ? i18n('entities.stacking.edit.title')
    : i18n('entities.stacking.new.title');
  ...
  return (
    <>
      {/* <Breadcrumb
        items={[
          [i18n('dashboard.menu'), '/'],
          [i18n('entities.stacking.menu'), '/stacking'],
          [title],
        ]}
      /> */}
...
export default StackingFormPage;
