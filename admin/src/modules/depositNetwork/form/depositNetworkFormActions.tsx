import vipService from 'src/modules/depositNetwork/depositNetworkService';
import Errors from 'src/modules/shared/error/errors';
import Message from 'src/view/shared/message';
import { getHistory } from 'src/modules/store';
import { i18n } from 'src/i18n';
import listActions from 'src/modules/depositNetwork/list/depositNetworkListActions';
...
const vipFormActions = {
  ...
  doInit: (id) => async (dispatch) => {
    try {
      ...
      getHistory().push('/depositNetwork');
    }
  },
