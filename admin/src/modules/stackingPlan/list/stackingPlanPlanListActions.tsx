import stackingPlanService from 'src/modules/stackingPlan/stackingPlanService';
import selectors from 'src/modules/stackingPlan/list/stackingPlanListSelectors';
import { i18n } from 'src/i18n';
import exporterFields from 'src/modules/stackingPlan/list/stackingPlanListExporterFields';
...
const vipListActions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await stackingPlanService.list(
        filter,
