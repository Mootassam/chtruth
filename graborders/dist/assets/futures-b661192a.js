...
`})]});return je.createPortal($,document.body)};function Ne(n){const{countFutures:p,futuretLoading:c,listFutures:x,handleOpenOrderModal:k,formatNumber:A,formatDateTime:S}=n;return e.jsxs("div",{className:"orders-container",children:[p&&!c&&(x==null?void 0:x.map(a=>{var C;return e.jsxs("div",{className:"order-card",onClick:()=>k(a),children:[e.jsxs("div",{className:"order-header",children:[e.jsx("div",{className:"order-pair",children:a.symbol||"BTC/USDT"}),e.jsx("div",{className:`order-direction ${a.futuresStatus==="long"?"buy":"sell"}`,children:a.futuresStatus==="long"?"BUY UP":"BUY DOWN"})]}),e.jsxs("div",{className:`order-status ${a.finalized?"closed":"open"}`,children:["● ",a.finalized?"Closed":"Open"]}),e.jsxs("div",{className:"order-details",children:[e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Futures Amount:"}),e.jsxs("span",{className:"order-value",children:["$",a.futuresAmount]})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Open Price:"}),e.jsx("span",{className:"order-value",children:A((C=a==null?void 0:a.openPositionPrice)==null?void 0:C.toString(),(a==null?void 0:a.openPositionPrice)>1e3?0:2)})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Open Time:"}),e.jsx("span",{className:"order-value",children:S(a.openPositionTime)})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Leverage:"}),e.jsxs("span",{className:"order-value",children:[a.leverage,"x"]})]})]})]},a.id)})),x.length===0&&!c&&e.jsxs("div",{className:"no-orders",children:[e.jsx("i",{className:"fas fa-file-invoice"}),e.jsx("div",{children:"No orders"})]}),e.jsx("style",{children:` .order-status {
          font-size: 12px;
          margin-bottom: 12px;
        }
        ...
        .order-status.closed {
          color: #777;
        }`})]})}function De(){const n=ve(),p=D(le.selectRows);D(le.selectLoading);const c=D(B.selectRows),x=D(B.pendingRows),k=D(B.pendingcount),A=D(B.pendingLoading),S=D(B.selectLoading),a=D(B.selectCount),[C,w]=o.useState(!1),[K,W]=o.useState(null),[X,y]=o.useState(!1),[m,l]=o.useState("BTCUSDT"),[P,f]=o.useState("0"),[b,T]=o.useState("0"),[U,_]=o.useState("0"),[v,I]=o.useState("0"),[M,z]=o.useState("0"),[L,Q]=o.useState("openOrders"),[F,V]=o.useState(null),[Y,g]=o.useState(!1),[q,O]=o.useState(!0),[ne,Z]=o.useState(!0),[ee,te]=o.useState(0),[oe,J]=o.useState([]),j=o.useRef(null),E=o.useRef(m),$=o.useRef(),r=o.useCallback((t,s=2)=>{if(t==null)return"0.00";const u=typeof t=="string"?parseFloat(t):t;return isNaN(u)?"0.00":u.toFixed(s)},[]),i=o.useCallback((t,s=2)=>{if(t==null)return"0.00";const u=typeof t=="string"?parseFloat(t):t;return isNaN(u)?"0.00":u.toLocaleString(void 0,{minimumFractionDigits:s,maximumFractionDigits:s})},[]),d=o.useCallback(t=>{if(t==null)return"0";const s=typeof t=="string"?parseFloat(t):t;return isNaN(s)?"0":s>=1e9?(s/1e9).toFixed(2)+"B":s>=1e6?(s/1e6).toFixed(2)+"M":i(s,0)},[i]),R=o.useCallback(t=>{if(!t)return"N/A";try{const s=new Date(t);if(isNaN(s.getTime()))return t;const u=new Date;return s.toDateString()===u.toDateString()?`Today ${s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:`${s.toLocaleDateString([],{month:"short",day:"numeric"})} ${s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`}catch(s){return console.error("Error formatting date:",s,t),t}},[]),de=o.useCallback(t=>{if(!t)return"N/A";try{const s=new Date(t);return isNaN(s.getTime())?t:`${s.toLocaleDateString([],{year:"numeric",month:"short",day:"numeric"})} ${s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}`}catch(s){return console.error("Error formatting date:",s,t),t}},[]),se=o.useCallback(()=>{if((p==null?void 0:p.length)>0){const t=p.find(s=>s.symbol==="USDT");te((t==null?void 0:t.amount)||0)}},[p]),re=o.useMemo(()=>L==="openOrders"?{count:k,loading:A,list:Array.isArray(x)?x:[]}:{count:a,loading:S,list:Array.isArray(c)?c:[]},[L,k,A,x,a,S,c]);o.useEffect(()=>{let t=!0;return(async()=>{if(m)try{O(!0);const u=await fetch(`https://api.binance.com/api/v3/ticker/24hr?symbol=${m}`);if(!u.ok)throw new Error("Failed to fetch ticker data");const h=await u.json();t&&(f(h.lastPrice||"0"),T(h.priceChangePercent||"0"),_(h.highPrice||"0"),I(h.lowPrice||"0"),z(h.volume||"0"),O(!1))}catch(u){console.error("Error fetching initial data:",u),t&&O(!1)}})(),()=>{t=!1}},[m]),o.useEffect(()=>{if(!m)return;let t=!0;E.current=m;const s=()=>{j.current&&j.current.close(),$.current&&clearTimeout($.current);try{j.current=new WebSocket(`wss://stream.binance.com:9443/ws/${m.toLowerCase()}@ticker`),j.current.onopen=()=>{},j.current.onmessage=u=>{if(t)try{const h=JSON.parse(u.data);h.s===E.current&&t&&(f(h.c||"0"),T(h.P||"0"),_(h.h||"0"),I(h.l||"0"),z(h.v||"0"))}catch(h){console.error("Error parsing WebSocket message:",h)}},j.current.onerror=u=>{console.error("Ticker WebSocket error:",u)},j.current.onclose=u=>{m===E.current&&t&&($.current=setTimeout(s,2e3))}}catch(u){console.error("WebSocket connection error:",u)}};return s(),()=>{t=!1,j.current&&j.current.close(),$.current&&clearTimeout($.current)}},[m]),o.useEffect(()=>{const t=setTimeout(()=>{Z(!1)},1500);return()=>clearTimeout(t)},[]),o.useEffect(()=>{let t=!0;return(async()=>{try{await Promise.all([n(G.doFetchPending()),n(ce.doFetch())])}catch(u){t&&console.error("Error fetching data:",u)}})(),()=>{t=!1}},[n]),o.useEffect(()=>{se()},[se]);const ue=o.useCallback(()=>{y(!0)},[]),pe=o.useCallback(()=>{y(!1)},[]),me=o.useCallback(t=>{O(!0),f("0"),T("0"),_("0"),I("0"),z("0"),l(t),y(!1)},[]),ae=o.useCallback(t=>{n(ce.doFetch()),W(t),w(!0)},[n]),xe=o.useCallback(()=>{w(!1),W(null)},[]),ge=o.useCallback(t=>{V(t),g(!0)},[]),he=o.useCallback(()=>{g(!1),V(null)},[]),ie=o.useCallback(t=>{t==="openOrders"?(Q("openOrders"),n(G.doFetchPending())):(Q("recentOrders"),n(G.doFetch()))},[n]),H=o.useCallback(({width:t="100%",height:s="1em"})=>e.jsx("div",{className:"loading-placeholder",style:{width:t,height:s}}),[]),be=o.useMemo(()=>`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${m.split("USDT")[0]}.png`,[m]);return e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"header",children:[e.jsxs("div",{className:"header-top",children:[e.jsxs("div",{className:"market-info",children:[e.jsx("div",{className:"market-icon",children:e.jsx("img",{src:be,style:{width:30,height:30},alt:m,loading:"lazy",onError:t=>{t.target.style.display="none"}})}),e.jsx("div",{className:"market-name",children:m}),e.jsx("div",{className:"market-change",style:{color:b!=null&&b.startsWith("-")?"#FF6838":"#00C076"},children:b!=="0"?`${b}%`:e.jsx(H,{width:"50px",height:"16px"})})]}),e.jsx("div",{className:"additional-actions",onClick:ue,children:e.jsx("i",{className:"fas fa-filter"})})]}),e.jsx("div",{className:"market-price",children:P!=="0"?`$${i(P)}`:e.jsx(H,{width:"120px",height:"28px"})}),e.jsxs("div",{className:"market-stats",children:[e.jsxs("span",{children:["24h High:"," ",U!=="0"?`$${i(U)}`:e.jsx(H,{width:"80px",height:"12px"})]}),e.jsxs("span",{children:["24h Vol:"," ",M!=="0"?`${d(M)} ${m.replace("USDT","")}`:e.jsx(H,{width:"80px",height:"12px"})]}),e.jsxs("span",{children:["24h Low:"," ",v!=="0"?`$${i(v)}`:e.jsx(H,{width:"80px",height:"12px"})]})]})]}),e.jsx(we,{symbol:m}),e.jsxs("div",{className:"future-action-buttons",children:[e.jsx("button",{className:"action-button buy-button",onClick:()=>ae("up"),children:"BUY UP"}),e.jsx("button",{className:"action-button sell-button",onClick:()=>ae("down"),children:"BUY DOWN"})]}),e.jsxs("div",{className:"section-tabs",children:[e.jsxs("div",{className:`tab ${L==="openOrders"?"active":""}`,onClick:()=>ie("openOrders"),children:["Open Orders (",k||0,")"]}),e.jsxs("div",{className:`tab ${L==="recentOrders"?"active":""}`,onClick:()=>ie("recentOrders"),children:["Recent Orders (",a||0,")"]})]}),e.jsx(Ne,{countFutures:re.count,futuretLoading:re.loading,listFutures:re.list,handleOpenOrderModal:ge,formatNumber:i,formatDateTime:R}),Y&&F&&e.jsx(ke,{selectedOrder:F,onClose:he,formatDateTimeDetailed:de,safeToFixed:r}),e.jsx(Fe,{isOpen:C,onClose:xe,direction:K,dispatch:n,listAssets:p,selectedCoin:m,marketPrice:P,availableBalance:ee,setOpeningOrders:J}),e.jsx(Ae,{isOpen:X,onClose:pe,onSelectCoin:me}),e.jsx("style",{children:`
        * {
          margin: 0;
          padding: 0;
