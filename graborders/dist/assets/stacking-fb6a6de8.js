import{h as d,I as ga,J as k,r as g,u as N,z as ma,ab as xa,m as ua,ac as ka,ad as B,o as K,j as a,ae as U}from"./index-de46be71.js";import{a as h,u as ha,y as ba,b as fa,F as va}from"./FormErrors-e5905afc.js";import{F as ya}from"./FieldFormItem-d77947ea.js";import{S as ja}from"./SubHeader-9e26b97e.js";import{D as W}from"./Dates-e41dcbaf.js";import{S as wa}from"./sucessModal-ad68c2a0.js";import{u as Na}from"./useDispatch-2fe88bcc.js";import"./v4-4a60fe23.js";const p=s=>s.plan.list,Sa=d([p],s=>s.loading),Da=d([p],s=>s.exportLoading),A=d([p],s=>s.rows),T=d([p],s=>s.count),za=d([T],s=>s>0),Ra=d([p],s=>s.sorter||{}),Fa=d([p],s=>{const o=s.sorter;if(!o||!o.field)return null;let b=o.order==="descend"?"DESC":"ASC";return`${o.field}_${b}`}),Ea=d([p],s=>s.filter),Aa=d([p],s=>s.rawFilter),Ta=d([p],s=>s.pagination.pageSize),Ca=d([p],s=>{const o=s.pagination;return!o||!o.pageSize?0:((o.current||1)-1)*o.pageSize}),Pa=d([p,T],(s,o)=>({...s.pagination,total:o})),Y=d([p],s=>s.selectedKeys),Ma=d([p,A],(s,o)=>o.filter(b=>s.selectedKeys.includes(b.id))),$a=d([A,Y],(s,o)=>s.length===o.length),La={selectLoading:Sa,selectRows:A,selectCount:T,selectOrderBy:Fa,selectLimit:Ta,selectFilter:Ea,selectOffset:Ca,selectPagination:Pa,selectSelectedKeys:Y,selectSelectedRows:Ma,selectHasRows:za,selectExportLoading:Da,selectRawFilter:Aa,selectIsAllSelected:$a,selectSorter:Ra},S=s=>s.stacking.form,Oa=d([S],s=>s.record),Va=d([S],s=>!!s.initLoading),Ia=d([S],s=>!!s.saveLoading),Ba=d([S],s=>!!s.showModal),Ka={selectInitLoading:Va,selectSaveLoading:Ia,selectRecord:Oa,selectModal:Ba,selectRaw:S},Ua=ga().shape({user:h.relationToOne(k("entities.stacking.fields.user"),{}),plan:h.relationToOne(k("entities.stacking.fields.plan"),{}),amount:h.decimal(k("entities.stacking.fields.amount"),{required:!0}),status:h.enumerator(k("entities.stacking.fields.status"),{options:["active","completed","cancelled"]}),startDate:h.datetime(k("entities.stacking.fields.startDate"),{}),endDate:h.datetime(k("entities.stacking.fields.endDate"),{}),earnedRewards:h.decimal(k("entities.stacking.fields.earnedRewards"),{})});function Xa(){const[s,o]=g.useState("options"),[b,C]=g.useState(!1),x=Na(),v=N(La.selectRows),H=N(ma.selectCurrentUser),z=N(xa.selectRows),D=N(ua.selectRows),[R,q]=g.useState({}),[P,M]=g.useState({}),[J,_]=g.useState(""),$=N(Ka.selectModal),G=()=>{x(U.doClose())},[c,Q]=g.useState({crypto:"",daily:"",balance:0,min:0,max:0,symbol:"",plan:"",unstakingPeriod:""}),[f,F]=g.useState(""),[X]=g.useState(()=>({user:"",plan:"",amount:"",status:"",startDate:"",endDate:"",earnedRewards:""})),y=ha({resolver:ba.yupResolver(Ua),mode:"all",defaultValues:X}),L=fa({control:y.control,name:"amount",defaultValue:""}),Z=()=>{if(D&&D.length>0){const e=D.reduce((t,n)=>(n.symbol&&n.amount!==void 0&&(t[n.symbol]=parseFloat(n.amount)||0),t),{});M(e)}};g.useEffect(()=>{F(L||"")},[L]),g.useEffect(()=>{Z()},[D]);const aa=async e=>{e.startDate=new Date;const t=new Date(e.startDate);t.setDate(t.getDate()+parseInt(c.unstakingPeriod)),e.endDate=t.toISOString(),e.status="active",e.plan=c.plan,e.user=H.id,_(e.amount);try{await x(U.doCreate(e)),x(K.doFetch()),x(B.doFetch()),M(n=>({...n,[c.symbol]:(n[c.symbol]||0)-parseFloat(f)})),O()}catch(n){console.error("Staking failed:",n)}},ea=()=>{if(!f||isNaN(f)||f<=0)return"0";const e=parseFloat(f),t=parseFloat(c.daily),n=parseFloat(c.unstakingPeriod);return(e*(t/100)*n).toFixed(6)},sa=()=>{const e=parseFloat(f),t=P[c.symbol]||0;return isNaN(e)||e<=0?{isValid:!1,message:"Enter an amount"}:e>t?{isValid:!1,message:"Insufficient balance"}:e<c.min?{isValid:!1,message:`Min: ${c.min}`}:e>c.max?{isValid:!1,message:`Max: ${c.max}`}:{isValid:!0,message:"Confirm Stake"}},ta=(e,t,n,r,i,l,m,u)=>{Q({crypto:e,daily:t,balance:n,min:r,max:i,symbol:l,plan:m,unstakingPeriod:u}),C(!0),F(""),y.setValue("amount","")},O=()=>{C(!1),F(""),y.setValue("amount","")},na=async()=>{try{const t=[...new Set(v.map(i=>i.currency))].map(async i=>{if(i==="USDT")return{currency:i,price:1};try{const m=await(await fetch(`https://api.binance.com/api/v3/ticker/price?symbol=${i}USDT`)).json();return{currency:i,price:parseFloat(m.price)}}catch(l){return console.error(`Error fetching price for ${i}:`,l),{currency:i,price:0}}}),n=await Promise.all(t),r={};n.forEach(i=>{r[i.currency]=i.price}),q(r)}catch(e){console.error("Error fetching crypto prices:",e)}},E=z.filter(e=>e.status==="active"),j=z.filter(e=>e.status==="completed"),ia=()=>{let e=0;return E.forEach(t=>{var l;const n=(l=t==null?void 0:t.plan)==null?void 0:l.currency,r=parseFloat(t.amount)||0,i=R[n]||0;e+=r*i}),e.toFixed(2)},oa=()=>{let e=0;return z.forEach(t=>{var l;const n=(l=t==null?void 0:t.plan)==null?void 0:l.currency,r=parseFloat(t.earnedRewards)||0,i=R[n]||0;e+=r*i}),e.toFixed(2)},ca=()=>{let e=0;return j.forEach(t=>{var l;const n=(l=t==null?void 0:t.plan)==null?void 0:l.currency,r=parseFloat(t.earnedRewards)||0,i=R[n]||0;e+=r*i}),e.toFixed(2)};g.useEffect(()=>(x(ka.doFetch()),x(B.doFetch()),x(K.doFetch()),()=>{}),[x]),g.useEffect(()=>{v.length>0&&na()},[v]);const V=sa(),I=!V.isValid,ra=V.message,la=e=>{const t=new Date,n=new Date(e.startDate);return Math.floor((t.getTime()-n.getTime())/(1e3*60*60*24))},da=e=>{const t=new Date,n=new Date(e.endDate),r=Math.floor((n.getTime()-t.getTime())/(1e3*60*60*24));return Math.max(0,r)},pa=()=>P[c.symbol]||0;return a.jsxs("div",{className:"stacking-container",children:[a.jsx("style",{children:`
        .stacking-container {
          max-width: 400px;
          margin: 0 auto;
