...
`})]});return je.createPortal(Z,document.body)};function Ne(n){const{countFutures:m,futuretLoading:c,listFutures:x,handleOpenOrderModal:N,formatNumber:k,formatDateTime:C}=n;return e.jsxs("div",{className:"orders-container",children:[m&&!c&&(x==null?void 0:x.map(a=>{var S;return e.jsxs("div",{className:"order-card",onClick:()=>N(a),children:[e.jsxs("div",{className:"order-header",children:[e.jsx("div",{className:"order-pair",children:a.symbol||"BTC/USDT"}),e.jsx("div",{className:`order-direction ${a.futuresStatus==="long"?"buy":"sell"}`,children:a.futuresStatus==="long"?"BUY UP":"BUY DOWN"})]}),e.jsxs("div",{className:`order-status ${a.finalized?"closed":"open"}`,children:["● ",a.finalized?"Closed":"Open"]}),e.jsxs("div",{className:"order-details",children:[e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Futures Amount:"}),e.jsxs("span",{className:"order-value",children:["$",a.futuresAmount]})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Open Price:"}),e.jsx("span",{className:"order-value",children:k((S=a==null?void 0:a.openPositionPrice)==null?void 0:S.toString(),(a==null?void 0:a.openPositionPrice)>1e3?0:2)})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Open Time:"}),e.jsx("span",{className:"order-value",children:C(a.openPositionTime)})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:"Leverage:"}),e.jsxs("span",{className:"order-value",children:[a.leverage,"x"]})]})]})]},a.id)})),x.length===0&&!c&&e.jsxs("div",{className:"no-orders",children:[e.jsx("i",{className:"fas fa-file-invoice"}),e.jsx("div",{children:"No orders"})]}),e.jsx("style",{children:` .order-status {
        ...
        .order-status.closed {
          color: #777;
        }`})]})}function De(){const n=ve(),m=T(ae.selectRows);T(ae.selectLoading);const c=T(O.selectRows),x=T(O.pendingRows),N=T(O.pendingcount),k=T(O.pendingLoading),C=T(O.selectLoading),a=T(O.selectCount),[S,b]=r.useState(!1),[J,y]=r.useState(null),[K,i]=r.useState(!1),[u,A]=r.useState("BTCUSDT"),[j,P]=r.useState("0"),[w,V]=r.useState("0"),[v,z]=r.useState("0"),[L,D]=r.useState("0"),[E,H]=r.useState("0"),[f,R]=r.useState("openOrders"),[$,g]=r.useState(null),[B,G]=r.useState(!1),[te,U]=r.useState(!0),[oe,_]=r.useState(!0),[q,X]=r.useState(0),[Q,Z]=r.useState([]),o=r.useRef(null),d=r.useRef(u),l=r.useRef(),I=r.useCallback((t,s=2)=>{if(t==null)return"0.00";const p=typeof t=="string"?parseFloat(t):t;return isNaN(p)?"0.00":p.toFixed(s)},[]),M=r.useCallback((t,s=2)=>{if(t==null)return"0.00";const p=typeof t=="string"?parseFloat(t):t;return isNaN(p)?"0.00":p.toLocaleString(void 0,{minimumFractionDigits:s,maximumFractionDigits:s})},[]),le=r.useCallback(t=>{if(t==null)return"0";const s=typeof t=="string"?parseFloat(t):t;return isNaN(s)?"0":s>=1e9?(s/1e9).toFixed(2)+"B":s>=1e6?(s/1e6).toFixed(2)+"M":M(s,0)},[M]),ce=r.useCallback(t=>{if(!t)return"N/A";try{const s=new Date(t);if(isNaN(s.getTime()))return t;const p=new Date;return s.toDateString()===p.toDateString()?`Today ${s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:`${s.toLocaleDateString([],{month:"short",day:"numeric"})} ${s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`}catch(s){return console.error("Error formatting date:",s,t),t}},[]),de=r.useCallback(t=>{if(!t)return"N/A";try{const s=new Date(t);return isNaN(s.getTime())?t:`${s.toLocaleDateString([],{year:"numeric",month:"short",day:"numeric"})} ${s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}`}catch(s){return console.error("Error formatting date:",s,t),t}},[]),re=r.useCallback(()=>{if((m==null?void 0:m.length)>0){const t=m.find(s=>s.symbol==="USDT");X((t==null?void 0:t.amount)||0)}},[m]),ee=r.useMemo(()=>f==="openOrders"?{count:N,loading:k,list:Array.isArray(x)?x:[]}:{count:a,loading:C,list:Array.isArray(c)?c:[]},[f,N,k,x,a,C,c]);r.useEffect(()=>{let t=!0;return(async()=>{if(u)try{U(!0);const p=await fetch(`https://api.binance.com/api/v3/ticker/24hr?symbol=${u}`);if(!p.ok)throw new Error("Failed to fetch ticker data");const h=await p.json();t&&(P(h.lastPrice||"0"),V(h.priceChangePercent||"0"),z(h.highPrice||"0"),D(h.lowPrice||"0"),H(h.volume||"0"),U(!1))}catch(p){console.error("Error fetching initial data:",p),t&&U(!1)}})(),()=>{t=!1}},[u]),r.useEffect(()=>{if(!u)return;let t=!0;d.current=u;const s=()=>{o.current&&o.current.close(),l.current&&clearTimeout(l.current);try{o.current=new WebSocket(`wss://stream.binance.com:9443/ws/${u.toLowerCase()}@ticker`),o.current.onopen=()=>{console.log(`Connected to ${u} ticker stream`)},o.current.onmessage=p=>{if(t)try{const h=JSON.parse(p.data);h.s===d.current&&t&&(P(h.c||"0"),V(h.P||"0"),z(h.h||"0"),D(h.l||"0"),H(h.v||"0"))}catch(h){console.error("Error parsing WebSocket message:",h)}},o.current.onerror=p=>{console.error("Ticker WebSocket error:",p)},o.current.onclose=p=>{u===d.current&&t&&(l.current=setTimeout(s,2e3))}}catch(p){console.error("WebSocket connection error:",p)}};return s(),()=>{t=!1,o.current&&o.current.close(),l.current&&clearTimeout(l.current)}},[u]),r.useEffect(()=>{const t=setTimeout(()=>{_(!1)},1500);return()=>clearTimeout(t)},[]),r.useEffect(()=>{let t=!0;return(async()=>{try{await Promise.all([n(Y.doFetchPending()),n(ie.doFetch())])}catch(p){t&&console.error("Error fetching data:",p)}})(),()=>{t=!1}},[n]),r.useEffect(()=>{re()},[re]);const ue=r.useCallback(()=>{i(!0)},[]),pe=r.useCallback(()=>{i(!1)},[]),me=r.useCallback(t=>{U(!0),P("0"),V("0"),z("0"),D("0"),H("0"),A(t),i(!1)},[]),ne=r.useCallback(t=>{n(ie.doFetch()),y(t),b(!0)},[n]),xe=r.useCallback(()=>{b(!1),y(null)},[]),ge=r.useCallback(t=>{g(t),G(!0)},[]),he=r.useCallback(()=>{G(!1),g(null)},[]),se=r.useCallback(t=>{t==="openOrders"?(R("openOrders"),n(Y.doFetchPending())):(R("recentOrders"),n(Y.doFetch()))},[n]),W=r.useCallback(({width:t="100%",height:s="1em"})=>e.jsx("div",{className:"loading-placeholder",style:{width:t,height:s}}),[]),be=r.useMemo(()=>`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${u.split("USDT")[0]}.png`,[u]);return e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"header",children:[e.jsxs("div",{className:"header-top",children:[e.jsxs("div",{className:"market-info",children:[e.jsx("div",{className:"market-icon",children:e.jsx("img",{src:be,style:{width:30,height:30},alt:u,loading:"lazy",onError:t=>{t.target.style.display="none"}})}),e.jsx("div",{className:"market-name",children:u}),e.jsx("div",{className:"market-change",style:{color:w!=null&&w.startsWith("-")?"#FF6838":"#00C076"},children:w!=="0"?`${w}%`:e.jsx(W,{width:"50px",height:"16px"})})]}),e.jsx("div",{className:"additional-actions",onClick:ue,children:e.jsx("i",{className:"fas fa-filter"})})]}),e.jsx("div",{className:"market-price",children:j!=="0"?`$${M(j)}`:e.jsx(W,{width:"120px",height:"28px"})}),e.jsxs("div",{className:"market-stats",children:[e.jsxs("span",{children:["24h High:"," ",v!=="0"?`$${M(v)}`:e.jsx(W,{width:"80px",height:"12px"})]}),e.jsxs("span",{children:["24h Vol:"," ",E!=="0"?`${le(E)} ${u.replace("USDT","")}`:e.jsx(W,{width:"80px",height:"12px"})]}),e.jsxs("span",{children:["24h Low:"," ",L!=="0"?`$${M(L)}`:e.jsx(W,{width:"80px",height:"12px"})]})]})]}),e.jsx(we,{symbol:u}),e.jsxs("div",{className:"future-action-buttons",children:[e.jsx("button",{className:"action-button buy-button",onClick:()=>ne("up"),children:"BUY UP"}),e.jsx("button",{className:"action-button sell-button",onClick:()=>ne("down"),children:"BUY DOWN"})]}),e.jsxs("div",{className:"section-tabs",children:[e.jsxs("div",{className:`tab ${f==="openOrders"?"active":""}`,onClick:()=>se("openOrders"),children:["Open Orders (",N||0,")"]}),e.jsxs("div",{className:`tab ${f==="recentOrders"?"active":""}`,onClick:()=>se("recentOrders"),children:["Recent Orders (",a||0,")"]})]}),e.jsx(Ne,{countFutures:ee.count,futuretLoading:ee.loading,listFutures:ee.list,handleOpenOrderModal:ge,formatNumber:M,formatDateTime:ce}),B&&$&&e.jsx(ke,{selectedOrder:$,onClose:he,formatDateTimeDetailed:de,safeToFixed:I}),e.jsx(Fe,{isOpen:S,onClose:xe,direction:J,dispatch:n,listAssets:m,selectedCoin:u,marketPrice:j,availableBalance:q,setOpeningOrders:Z}),e.jsx(Ae,{isOpen:K,onClose:pe,onSelectCoin:me}),e.jsx("style",{children:`
        * {
          margin: 0;
          padding: 0;
