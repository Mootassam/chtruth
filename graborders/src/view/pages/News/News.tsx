  ...
  <div className="news-list">
    ...
    <div className="news-item">
      ...
      <div className="news-content">
        Major companies continue to add Bitcoin to their balance sheets, driving
        prices to new yearly highs amid growing institutional adoption.
      </div>
    ...
    <div className="news-item">
      ...
      <div className="news-content">
        The upcoming network update promises to significantly lower transaction
        costs and improve scalability for the Ethereum ecosystem.
      </div>
      <div className="news-footer">
        <div className="news-tags">
    ...
    <div className="news-item">
      ...
      <div className="news-content">
        ...
        guidelines for cryptocurrency exchanges and protecting consumer assets.
      </div>
      <div className="news-image">
  ...
  <div className="trending-section">
    ...
    <ul className="trending-list">
      ...
      <li className="trending-item">
        ...
        <div className="trending-content">
          <div className="trending-title">DeFi Protocol Reaches $100B TVL</div>
          <div className="trending-stats">
